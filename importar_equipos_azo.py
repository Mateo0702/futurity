...
def ejecutar_importacion_azo():
    excel_path = 'equipos_azo.xlsx'
    print(f"Leyendo archivo {excel_path} (Azogues)...")
    ...
    try:
        ...
        for idx, row in df.iterrows():
            ...
            olt = clean_val(row.get('OLT')) or 'AZO'
            ...
            ip_nodo_master = '10.17.200.52'

            # Buscar contrato exacto o con sufijos oficiales (A, D, F, I)
            ...
            if contrato_target:
                ...
                cur.execute(insert_sql, (
                    contrato, 'SERVICABLE', cliente or 'CLIENTE NUEVO', zona,
                    sn_ont, modelo_ont, router_principal, router_secundario,
                    tipo_mesh, cantidad_routers, modo_acceso, ip_address, ip_nodo_master
                ))
                insertados += 1
        ...
        conn.commit()
        print("\n==========================================")
        print("[OK] PROCESO DE ACTUALIZACION AZO (AZOGUES) FINALIZADO")
        print("==========================================")
