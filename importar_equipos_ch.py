...
def ejecutar_importacion_ch():
    excel_path = 'equipos_ch.xlsx'
    ...
    try:
        ...
        for idx, row in df.iterrows():
            ...
            olt = clean_val(row.get('OLT')) or 'CH'
        ...
        conn.commit()
        print("\n==========================================")
        print("[OK] PROCESO DE ACTUALIZACION CH FINALIZADO")
        print("==========================================")
